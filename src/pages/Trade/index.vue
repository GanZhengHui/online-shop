<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in userAddressInfo" :key="address.id">
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        "paymentWay": "ONLINE", //在线支付方式
        "orderComment": this.msg, //买家留言
        "orderDetailList": this.orderInfo.detailArrayList //购买的商品列表
      }
